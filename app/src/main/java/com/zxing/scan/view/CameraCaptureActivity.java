...
import com.zxing.widget.CustomToast;
 ...
 * @author Ryan.Tang
 */
public class CameraCaptureActivity extends Activity implements Callback, OnClickListener {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == SCAN_REQUEST_CODE) {
			...
			CustomToast.showToast(this,"nimamamama");
		}
	}
}